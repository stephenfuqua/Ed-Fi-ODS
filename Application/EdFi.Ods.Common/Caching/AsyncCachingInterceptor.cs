...
/// </summary>
public class AsyncCachingInterceptor : IInterceptor, IClearable
{
    ...
    private readonly IAsyncCacheProvider<ulong> _asyncCacheProvider;
    private readonly ICacheProvider<ulong> _localCacheProvider;

    public AsyncCachingInterceptor(IAsyncCacheProvider<ulong> asyncCacheProvider, ICacheProvider<ulong> localCacheProvider)
    {
    ...
    public void Intercept(IInvocation invocation)
    {
        ...
        if (returnType.IsGenericType && returnType.GetGenericTypeDefinition() == typeof(Task<>))
        {
            ...
            invocation.ReturnValue = InterceptAsyncWithResultMethod.MakeGenericMethod(resultType)
                .Invoke(this, new object[] { invocation, cacheKey })!;
